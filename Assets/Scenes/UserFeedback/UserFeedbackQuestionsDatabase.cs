...
public class UserFeedbackQuestionsDatabase : MonoBehaviour, IFeedbackDatabase
{
    private List<FeedbackQuestion> questions = new List<FeedbackQuestion>
    {
        ...
        new FeedbackQuestion
        {
            ...
            titleText = "Você já usou outro aplicativo ou método para estudar bioquímica antes deste?",
        ...
        new FeedbackQuestion
        {
            ...
            maxCharacters = 100,
            placeholderText = "Ex: Diariamente, Algumas vezes por semana, etc."
        },
        new FeedbackQuestion
        {
            id = "usage_purpose",
        ...
        new FeedbackQuestion
        {
            ...
            titleText = "Por favor, explique o motivo da sua recomendação ou não recomendação.",
            feedbackAnswerType = FeedbackAnswerType.Text,
            isRequired = true,
            category = "Sugestões e Comentários",
            maxCharacters = 500
